...
const Intro = () => {
  ...
  const img_300 = "https://drive.google.com/uc?id=1NxR25C9_Fe-_MQtJKrgSyWJrEdT5MvxM";
  const title_name = homeDetails && homeDetails.map((detail2) => detail2.name);
  // https://drive.google.com/file/d/1NxR25C9_Fe-_MQtJKrgSyWJrEdT5MvxM/view?usp=drive_link
  useEffect(() => {
